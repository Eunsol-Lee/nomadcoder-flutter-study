      ...
      routes: [
        GoRoute(
          ...
          pageBuilder: (context, state) =>
              NoTransitionPage(child: const LoginPage(), key: state.pageKey),
        ),
        GoRoute(
          path: SignupPage.routePath,
          name: SignupPage.routeName,
          pageBuilder: (context, state) =>
              NoTransitionPage(child: const SignupPage(), key: state.pageKey),
        ),
      ],
    ),
    GoRoute(
      ...
      pageBuilder: (context, state) =>
          NoTransitionPage(child: const ErrorPage(), key: state.pageKey),
    ),
  ],
);
